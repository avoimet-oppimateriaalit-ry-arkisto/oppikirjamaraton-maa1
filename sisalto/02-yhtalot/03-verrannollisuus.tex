...
\laatikko{
Kaksi muuttujaa $x$ ja $f(x)$ ovat suoraan verrannolliset, jos toinen saadaan
toisesta kertomalla se jollakin vakiolla, eli $f(x) = kx$. Vakiota $k$
kutsutaan \emph{verrannollisuuskertoimeksi}.}

Suoraan verrannollisuus voidaan monesti havaita laskemalla muuttujien
...
Muita esimerkkejä suoraan verrannollisista muuttujista ovat
\begin{itemize}
...
\laatikko{
Muuttujat $x$ ja $f(x)$ ovat kääntäen verrannolliset, jos toinen saadaan toisesta
jakamalla jokin vakio sillä, eli $f(x) = \frac{a}{x}$.
}

Kääntäen verrannollisuus voidaan käytännössä havaita esimerkiksi
kertomalla muuttujat keskenään eri muuttujan arvoilla ja huomaamalla,
että tulo on vakio.
...
Muita esimerkkejä kääntäen verrannollisia muuttujista ovat
\begin{itemize}
