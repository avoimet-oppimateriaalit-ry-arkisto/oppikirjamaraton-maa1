...
Yhtälötyypin nimi tulee siitä, että korkein potenssi, johon muuttuja $x$
...
\laatikko{
Ensimmäisen asteen yhtälö ratkaistaan siirtämällä ensin muuttujan $x$ sisältävät termit yhtälön vasemmalle puolelle ja vakiotermit oikealle puolelle. Tämän jälkeen yhtälö jaetaan puolittain muuttujan $x$ kertoimella.
}
