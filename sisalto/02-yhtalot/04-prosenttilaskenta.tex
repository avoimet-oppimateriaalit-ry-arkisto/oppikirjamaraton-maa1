...
\begin{tehtava}
Kaupungissa tuli jokaisen talonomistajan suorittaa kaupungin kassaan 5 \% saadusta hyyrymäärästä. Sittemmin määrättiin, että mainittu prosentti oli oleva 10. Monellako prosentilla täytyy talonomistajien korottaa hyyryjä saadakseen saman puhtaan säästön kuin ennen? 
    \begin{vastaus}
5,6\%
    \end{vastaus}
\end{tehtava}