...
Esmerkiksi voidaan pohtian, mitä tarkoittaa merkintä $2^\frac{1}{3}$? Potenssien laskusäätöjen mukaan. Potenssin laskusääntöjen perusteella
\[
...
pätevät kaikille rationaaliluvuille $p$ ja $q$.  Näinden kaavojen odistukset on esitetty liitteessä \ref{pot_todistukset}.
...
\]
Luvun $\frac{1}{3}$ lavennus muotoon $\frac{2}{6}$ on ongelman ydin, mutta murtolukujen lavennussäännöistä lopuminen olisi mysö hankalaa. Siksi sovitaan, ettei murtopotenssimerkintää käytetä, jos kantaluku on negatiivinen.
