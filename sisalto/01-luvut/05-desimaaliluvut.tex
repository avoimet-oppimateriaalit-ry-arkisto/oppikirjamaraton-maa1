...
\begin{itemize}
	...
	\item Kokonaisluku erotetaan loppuosasta \emph{desimaalierottimella}, joka on Suomessa pilkku (,). Useissa englanninkielisissä maissa käytetään desimaalierottimena pistettä ja pilkku on tuhaterotin. Esimerkiksi yhdysvaltalaisessa kirjassa merkintä \$ 1,000.50 tarkoittaa tuhatta dollaria ja 50 senttiä. % Pitäisikö tämän olla \footnote:ssa?
...
\todo{pitää kertoa, että n-lukujärjestelmässä käytetään vain numeroita 0-n!!}
