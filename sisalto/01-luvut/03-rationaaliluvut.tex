...
\subsection*{Hallitse kokonaisuutta}
...
\end{tehtava}
    ...
    \begin{tehtava} %syvteht
Ratkaise lausekkeen $\frac{1}{n}-\frac{1}{m}$ arvo, kun tiedetään, että $n = \frac{1}{6}$ ja $m=n+1$ ja .
        \begin{vastaus}
            $5 \frac{1}{7}$
        \end{vastaus}
    \end{tehtava}
Ratkaise lausekkeen 1/n-1/m arvo, kun tiedetään, että m=n+1 ja n*m=6.
