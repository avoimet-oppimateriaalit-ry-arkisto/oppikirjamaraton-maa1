...
\section{Tiivistelmä}
    ...
    \todo{tiivistelmästä puuttuu jaollisuus}
...
\section*{Tehtäviä}
    ...
    \begin{tehtava}
        Kirjoita laskutoimitukseksi.
        \begin{enumerate}[a)]
            \item Pakkasta on aluksi $-10^{\circ}$C ja sitten pakkanen kiristyy (lisääntyy) kaksi astetta.
            \item Pakkasta on aluksi $-20^{\circ}$C ja sitten pakkanen hellittää (vähentyy) kolme astetta.
            \item Lämpötila on aluksi $17^{\circ}$C ja sitten lämpötila vähentyy viisi astetta.
            \item Lämpötila on aluksi $5^{\circ}$C ja sitten lämpötila kasvaa kuusi astetta.
