...
\section{Yhteen- ja vähennyslasku}
    ...
    \begin{center}
      %    \includegraphics[scale=0.5]{01-luvut/kuvia/5plus8on13-crop.pdf} FIXME Poista tiedosto samalla kun poistat tämän rivin
...
%\vspace{0.3cm}     
    ...
    \begin{center}
    % \includegraphics[scale=0.5]{01-luvut/kuvia/5plusplus8on13-crop.pdf} FIXME Poista tiedosto samalla kun poistat tämän rivin
          \begin{lukusuora}{-1}{14}{14}
        {\color{red} \lukusuoravaliss{0}{5}{$0$}{$5$}}
        \lukusuorauusi
        {\color{red} \lukusuoravaliss{8}{13}{$8$}{${\color{black}13}$}}
...
\vspace{0.3cm}     
    ...
    \begin{center}
    % \includegraphics[scale=0.5]{01-luvut/kuvia/5miinusplus8onmiinus3-crop.pdf} FIXME Poista tiedosto samalla kun poistat tämän rivin
...
\vspace{0.3cm}     
    ...
    \begin{center}
    %\includegraphics[scale=0.5]{01-luvut/kuvia/5plusmiinus8onmiinus3-crop.pdf} FIXME Poista tiedosto samalla kun poistat tämän rivin
                 \begin{lukusuora}{-4}{8}{14}
        {\color{blue} \lukusuoravaliss{-3}{5}{\color{black}$-3$}{$5$}}
        \lukusuorauusi
%        {\color{red} \lukusuoravaliss{8}{13}{$8$}{${\color{black}13}$}}
...
\vspace{0.3cm}     
    ...
    \begin{center}
    %\includegraphics[scale=0.5]{01-luvut/kuvia/5miinusmiinus8on13-crop.pdf} FIXME Poista tiedosto samalla kun poistat tämän rivin
    \begin{lukusuora}{-1}{14}{14}
        {\color{red} \lukusuoravaliss{0}{5}{$0$}{$5$}}
        \lukusuorauusi
        {\color{red} \lukusuoravaliss{8}{13}{$8$}{${\color{black}13}$}}
