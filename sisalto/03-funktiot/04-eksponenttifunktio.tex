...
$x$ on sen sijaan eksponenttina, saadaan oleellisesti erilainen joukko
funktioita.

\laatikko{Muotoa $f(x) = a^x$, $a > 0$, $a \neq 1$ olevia
funktioita kutsutaan eksponenttifunktioiksi.}
...
kantaluvulle ei ole määritelty yleistä potenssia, jossa eksponentti
on reaaliluku, joten funktion arvoa ei voida laskea millä hyvänsä
muuttujan $x$ arvolla.
