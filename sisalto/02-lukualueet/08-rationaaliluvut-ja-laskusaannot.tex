\chapter{Rationaaliluvut ja murtolukujen laskusäännöt}
...
\laatikko{
Murtoluvut ovat lukujen esitystapa muodossa $\frac{m}{n}$, jossa $m$ ja $n$
ovat kokonaislukuja ja $n \neq 0$. Jakoviivan yläpuolista osaa kutsutaan \emph{osoittajaksi} ja alapuolista osaa \emph{nimittäjäksi}.
}
...
Kaksi murtolukua voidaan laskea yhteen seuraavien sääntöjen perusteella:

\laatikko{
Jos nimittäjät ovat samat, summan osoittaja on osoittajien summa:
\begin{equation}
