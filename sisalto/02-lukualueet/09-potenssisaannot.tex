...
\\
\\
>>>>>>> bb018dad0d50b58643d639a49cfdddc485fa62c6
\begin{esimerkki}
Potenssit luvuilla.
...
Sievennetään osamäärä $\frac{x^3}{x^5}$ kahdella eri tavalla. Supistamalla yhteiset tekijät lopputulos

\begin{equation}
\frac{x^3}{x^5}=\frac{\cancel{x}\cdot \cancel{x}\cdot \cancel{x}}{x\cdot x\cdot \cancel{x}\cdot \cancel{x}\cdot \cancel{x}}=\frac{1}{x\cdot x}=\boldsymbol{\frac{1}{x^2}}
\end{equation}

on erinäköinen, kuin käyttämällä potenssien laskusääntöjä

\begin{equation}
\frac{x^3}{x^5}=x^{3-5}=\boldsymbol {x^{-2}}{.}
\end{equation}
