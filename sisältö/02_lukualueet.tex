...
\begin{equation}
 Eli $2^4=2\cdot 2\cdot 2\cdot 2=16$.
\end{equation}
...
c) $2^2\cdot 2^3=\underbrace{2\cdot 2}_{2 kpl}\cdot \underbrace{2\cdot 2\cdot 2}_{3 kpl}=2^5=32$
d) $\frac{2^4\cdot 2^2}{2^3}=\frac{\overbrace{2\cdot 2\cdot 2\cdot \cancel{2}}\cdot \overbrace{\cancel{2}\cdot \cancel{2}{\cancel{2}\cdot \cancel{2}\cdot \cancel{2}}
